        ...
        card += `
            <div class="card mb-3">
                <div class="row g-0">
                    <div class="col-md-8">
                        <div class="card-body">
                            <h5 class="card-title">${countries[i].name.official}</h5>
                            <div class="name-flag-container">
                                <img src="${countries[i].flags.svg}" style="max-width: 2em"> 
                                <p class="card-text">${countries[i].name.common}</p>
                            </div>
                            <div class="time-zone">
                                ...
                                <p class="card-text" style="overflow:auto; height:3.9vh">
                                    ${countries[i].timezones}
                                </p>
                            </div>
                            <div class="location">
                                ...
                                <a href="${countries[i].maps.googleMaps}">Location</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
